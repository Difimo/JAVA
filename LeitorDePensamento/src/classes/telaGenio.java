...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, 190, 120));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 386, 50, 20));

        txtVal.setModel(new javax.swing.SpinnerNumberModel(1, 1, 5, 1));
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, 60, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, -1, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        int m= (int)(1+ Math.random()*(6-1));
        
        
        
        int num = Integer.parseInt(txtVal.getValue().toString());
        String f1 = "<html>Acertou Eu pensei no, " +m+" tambem!!!</html>" ;
        String f2 = "ERROU Eu pensei no" + m;
        
        String res= (m == num)?f1:f2;
